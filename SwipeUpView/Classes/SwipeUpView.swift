...
public class SwipeUpView: UIView  {
    ...
    private func adjustMyHeight(heigthIndex : Int){
        ...
        if(newHeight <= 0){
            ...
            UIView.animate(withDuration: datasource.animationUpSpeed(self), animations: {
    ...
    private func addItemContainerView() {
        ...
        headerContainerButton.layer.zPosition = 1
    ...
    public  func closeViewPage()  {
        ...
        UIView.animate(withDuration: datasource.animationDownSpeed(self), animations: {
